...
(function () {
  ...
  COF.PROFILS.pretre.voies.push(
    { id: 'corruption', nom: 'Voie de la corruption', caps: [
      ...
      { r: 3, n: 'Blessure majeure', a: 'L', s: true, f: 'combat', dmg: '2d4°+niveau', d: "Une fois par combat, blesse automatiquement une cible à 20 m : [2d4° + niveau] DM (+1d4° par rang 5 atteint dans une voie de prêtre)." },
