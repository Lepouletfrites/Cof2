...
COF.PRESTIGE.archimage = {
  ...
  caps: [
    ...
    { r: 5, n: 'Bâton magique', choix: true, choixVoie: { familles: ['mage'], rangMax: 1, sorts: true }, d: "Un sort de rang 1 de la famille des mages est lié à son bâton : utilisable en action de mouvement sans dépense de mana. À partir du rang 7, ajoute un sort de rang 2 également gratuit." },
