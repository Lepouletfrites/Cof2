...
COF.PROFILS.barbare = {
  ...
  voies: [
    { id: 'brute', nom: 'Voie de la brute', caps: [
      ...
      { r: 3, n: 'Attaque brutale', a: 'L', dmg: '1d4°', d: "Attaque au contact : +1d4° DM ; ou -3 au test d'attaque pour +2d4° DM. Peut sacrifier 1d4° DM pour repousser de 3 m un adversaire de NC < rang, ou 2d4° pour le renverser." },
    ...
    { id: 'pourfendeur', nom: 'Voie du pourfendeur', caps: [
      ...
      { r: 2, n: 'Charge', a: 'L', dmg: '1d4°', d: "Déplacement de 5 à 10 m en ligne droite puis attaque au contact avec dé bonus et +1d4° DM. Impossible s'il est déjà au contact." },
    ...
    { id: 'primitif', nom: 'Voie du primitif', caps: [
      ...
      { r: 5, n: 'Vitalité débordante', dmg: '1d4°', d: "Tant que ses PV sont entre 1 et le tiers de son maximum, il récupère 1d4° PV par heure, jour et nuit." }
    ]},
    { id: 'rage', nom: 'Voie de la rage', caps: [
      ...
      { r: 3, n: 'Rage du berserk', a: 'L', f: 'jour', dmg: '1d4°', d: "1×/jour (+1 par rang 4 atteint dans une voie de barbare) : +1d4° DM au contact, -2 en DEF, pas de fuite ni d'attaque à distance, dé bonus aux tests de VOL. Fin anticipée : test de VOL difficulté 15. Aucun sort ni capacité de concentration pendant la rage." },
      ...
      { r: 5, n: 'Furie du berserk', a: 'L', dmg: '2d4°', d: "Consomme 2 utilisations de rage : +2d4° DM au lieu de 1d4°, -4 en DEF. Difficulté 20 pour y mettre fin prématurément." }
    ]}
  ]
};
...
COF.PROFILS.chevalier = {
  ...
  voies: [
    { id: 'cavalier', nom: 'Voie du cavalier', caps: [
      ...
      { r: 3, n: 'Charge', a: 'L', dmg: '1d4°', d: "À cheval : 10 à 20 m en ligne droite puis attaque au contact avec dé bonus et +1d4° DM. Une créature qui s'interpose doit réussir un test de FOR difficulté 20 ou céder le passage en subissant 1d4° DM." },
    ...
    { id: 'preux', nom: 'Voie du preux', caps: [
      ...
      { r: 3, n: 'Laissez-le-moi', dmg: '1d4°', d: "Contre un leader ennemi identifiable dans un groupe de 4 créatures ou plus : +1d4° DM au contact. La cible doit réussir un test d'INT difficulté 15 ou ne pourra attaquer que lui au prochain tour." },
    ...
    { id: 'meneur', nom: "Voie du meneur d'hommes", caps: [
      ...
      { r: 4, n: 'Charge fantastique', a: 'G', f: 'combat', dmg: '1d4°', d: "1×/combat : tous ses alliés en vue et lui gagnent 10 m de déplacement supplémentaire, un dé bonus et +1d4° DM à toutes leurs attaques. Non cumulable avec Exemplaire ou Ordre de bataille." },
    ...
    { id: 'noblesse', nom: 'Voie de la noblesse', caps: [
      ...
      { r: 4, n: 'Massacrer la piétaille', dmg: '1d4°', d: "+1d4° DM contre la piétaille (au moins 4 créatures semblables impliquées dans le combat). Les cavaliers ne sont jamais de la piétaille." },
...
COF.PROFILS.guerrier = {
  ...
  voies: [
    ...
    { id: 'combat', nom: 'Voie du combat', caps: [
      ...
      { r: 3, n: 'Attaque puissante', dmg: '2d4°', d: "Dé malus volontaire sur une attaque au contact : +2d4° DM. En action limitée (L) : +3d4° DM. Cumulable avec Double attaque, Attaque circulaire ou Attaque parfaite." },
    ...
    { id: 'maitrearmes', nom: "Voie du maître d'armes", caps: [
      ...
      { r: 4, n: 'Attaque parfaite', a: 'L', dmg: '1d4°', d: "Dé bonus en attaque (contact ou arme de jet) et +1d4° DM avec une arme de prédilection. Peut renoncer aux DM pour désarmer une cible de NC < son bonus de DM de spécialisation." },
