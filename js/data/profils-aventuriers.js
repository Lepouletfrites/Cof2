...
COF.PROFILS.arquebusier = {
  ...
  voies: [
    ...
    { id: 'pistolero', nom: 'Voie du pistolero', caps: [
      ...
      { r: 5, n: 'As de la gâchette', dmg: '2d4°', d: "Attaque à distance à l'arme à poudre ou à l'arbalète : si le résultat dépasse la DEF de 10 points ou plus, +2d4° aux DM." }
    ]},
    { id: 'precision', nom: 'Voie de la précision', caps: [
      ...
      { r: 4, n: "Tireur d'élite", a: 'L', dmg: '2d4°', d: "Cible à 10 m minimum : double la portée de l'arme et +2d4° aux DM. Impossible au contact ou en position instable." },
...
COF.PROFILS.barde = {
  ...
  voies: [
    { id: 'escrime', nom: "Voie de l'escrime", caps: [
      ...
      { r: 2, n: 'Feinte', a: 'L', dmg: '2d4°', d: "Test opposé de CHA contre PER. Au round suivant : bonus d'attaque égal au double du rang sur la première attaque au contact contre cette cible et, si la feinte a réussi, +2d4° aux DM." },
      ...
      { r: 5, n: 'Botte mortelle', dmg: '2d4°', d: "Attaque au contact à l'arme légère : si le résultat dépasse la DEF de 10 points ou plus, +2d4° aux DM." }
    ]},
    { id: 'musicien', nom: 'Voie du musicien', caps: [
      ...
      { r: 2, n: 'Chant de réconfort', a: 'L', s: true, dmg: '1d4°', d: "Joue pendant une récupération rapide (30 min) : lui et ses alliés dans 10 m récupèrent 1d4° PV (2d4° au rang 4)." },
...
COF.PROFILS.rodeur = {
  ...
  voies: [
    { id: 'archer', nom: "Voie de l'archer", caps: [
      ...
      { r: 3, n: 'Dans le mille', dmg: '2d4°', d: "Attaque à distance avec dé malus volontaire : +2d4° aux DM si réussie. En action limitée (L) : +3d4° au lieu de +2d4°." },
      { r: 4, n: 'Tir rapide', a: 'L', d: "Deux attaques à distance pendant son tour avec -2 à chacune." },
      { r: 5, n: 'Flèche de mort', a: 'L', dmg: '1d4°', d: "Dé bonus en attaque à distance et +1d4° aux DM. À la place : inflige un état (aveuglé, affaibli, ralenti ou immobilisé) 1 round à une cible de NC inférieur — chaque état une seule fois par combat." }
    ]},
    { id: 'compagnon', nom: 'Voie du compagnon animal', caps: [
      ...
      { r: 5, n: 'Tactiques de meute', dmg: '1d4°', d: "Si le loup attaque la même cible que le rôdeur : +1d4° aux DM. Chaque PV sacrifié rend 2 PV au loup. +1 en DEF pour les deux par rang 5 atteint dans une voie de rôdeur." }
    ]},
    { id: 'survie', nom: 'Voie de la survie', caps: [
      { r: 1, n: 'Survie', comp: "escalade et survie en milieu naturel (tests de récupération inclus)", bon: '2+rang', dmg: '1d4°', d: "Ajoute rang + 2 à ces tests. En dormant en pleine nature, dépenser 1 DR rend 1d4° PV de plus." },
      ...
      { r: 4, n: 'Constitution héroïque', d: "+1 en CON et dé bonus aux tests de CON." },
      { r: 5, n: 'Increvable', a: 'L', f: 'combat', dmg: '4d4°+CON', d: "1×/combat, en tombant à 0 PV : récupère [4d4° + CON] PV au début de son prochain tour, +5 en DEF pendant 1 round et se débarrasse de tous ses états préjudiciables non permanents." }
    ]},
    { id: 'traqueur', nom: 'Voie du traqueur', caps: [
      ...
      { r: 3, n: 'Chasseur émérite', dmg: '1d4°', d: "+1d4° aux DM contre les animaux (même géants). Par rang 5 atteint dans une voie de rôdeur, choisir un ennemi juré supplémentaire : gobelinoïdes, géants, dragons, morts-vivants, insectes, démons." },
    ...
    { id: 'deuxarmes', nom: 'Voie du combat à deux armes', caps: [
      ...
      { r: 5, n: 'Double peine', dmg: '1d4°', d: "Si les deux armes touchent la même cible dans le même tour : +1d4° DM sur l'une des deux attaques." }
    ]}
  ]
};
...
COF.PROFILS.voleur = {
  ...
  voies: [
    { id: 'assassin', nom: "Voie de l'assassin", caps: [
      ...
      { r: 2, n: 'Attaque sournoise', a: 'L', f: 'round', dmg: '2d4°', d: "1×/round contre un adversaire surpris ou attaqué de dos, avec une arme légère : +2d4° DM (+1d4° par rang 4 atteint dans une voie de voleur, max 7d4°). Bonus divisé par 2 avec une autre arme." },
      { r: 3, n: 'Attaque par surprise', a: 'A', dmg: '2d4°', d: "Contre un adversaire surpris : attaque sournoise en action d'attaque au lieu d'une action limitée, et +2d4° DM supplémentaires." },
    ...
    { id: 'aventurier', nom: "Voie de l'aventurier", caps: [
      ...
      { r: 2, n: 'Provocation', a: 'L', dmg: '1d4°', d: "Test opposé de CHA contre INT (10 m) : la cible humanoïde doit l'attaquer à son prochain tour. S'il est au contact, riposte gratuite avec au choix attaque sournoise ou +1d4° DM." },
      ...
      { r: 5, n: 'Attaque paralysante', a: 'L', f: 'combat', dmg: '1d4°', d: "1×/combat, sur une attaque de contact réussie : aucun DM, mais la cible humanoïde est immobilisée 1d4 rounds (paralysée si NC < ½ niveau). De plus +1d4° DM (ou attaque sournoise) contre toute cible immobilisée ou paralysée." }
    ]},
    { id: 'deplacement', nom: 'Voie du déplacement', caps: [
      ...
      { r: 3, n: 'Acrobaties', a: 'G', f: 'round', dmg: '1d4°', d: "1×/round, test d'AGI difficulté 15 : franchit un obstacle (ou un adversaire) ou attaque de dos un adversaire au contact — au choix attaque sournoise ou +1d4° DM." },
      { r: 4, n: 'Agilité héroïque', d: "+1 en AGI et dé bonus aux tests d'AGI." },
    ...
    { id: 'roublard', nom: 'Voie du roublard', caps: [
      ...
      { r: 3, n: 'Feindre la mort', a: 'G', f: 'combat', dmg: '1d4°', d: "1×/combat : passe pour mort (test d'INT difficulté 20 pour le démasquer). En se relevant (action gratuite) : récupère 1d4° PV et surprend l'adversaire au contact." },
      ...
      { r: 5, n: 'Maître du poison', f: 'jour', dmg: '2d4°', d: "3 doses de poison par jour sans risque. Une dose enduite sur une arme : +2d4° DM et test de CON difficulté [10 + INT] ou cible affaiblie pour le combat. Ou versée dans un repas : inconscience 2d6 min en cas d'échec." }
    ]},
